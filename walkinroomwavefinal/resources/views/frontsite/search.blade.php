...
@section('content')
		...
		<!-- Main Container  -->
		<div class="breadcrumbs" id="myDiv">
			<div class="container">
								...
								<div class="product-item-container item">
									<div class="item-block so-quickview">
										...
										<div class="clearfix item-content">
                                            <h3><a href="{{ route('roomdetail',['id'=>$room->id, $pp, $datedif]) }}">{{ $room->title }}</a></h3>
                                            {{-- <h3><a href="{{ url('/roomdetail/ ' . $room->id . '/' . $pp )}}">{{ $room->title }}</a></h3> --}}

											{{-- <h3><a href="{{route('roomdetail',route('comment.show', ['post' => 1, 'comment' => 3]) ['id' => $room->id], ['pp' => $pp])}}">{{ $room->title }}</a></h3> --}}
											...
											<div class="clearfix item-bot">
												<div class="price pull-left">
													from <label>${{ $pp }}</label><span>person</span>
												</div>
