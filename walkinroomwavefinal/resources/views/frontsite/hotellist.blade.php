								...
								<div class="product-item-container item">
									<div class="item-block so-quickview">
										...
										<div class="clearfix item-content">
											<h3><a href="{{ route('hoteldetail',['id'=>$hotel->id]) }}">{{ $hotel->name }}</a></h3>
											...
											<ul>
												<li><i class="fa fa-map-marker" aria-hidden="true"></i> {{ $hotel->location->city }}</li>
												<li><i class="fa fa-clock-o" aria-hidden="true"></i> 2 Day</li>
												<li><i class="fa fa-user-circle" aria-hidden="true"></i> {{ $hotel->roomQuantity }}</li>
											</ul>
