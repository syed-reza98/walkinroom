...
@section('content')
        ...
        @endphp
		<div class="image-top"><img src="{{ Storage::url("{$value}") }}" alt="tour" class="img-responsive"></div>
		<!-- Main Container  -->
							...
							<div class="tab-content">
									...
									<ul class="location-wee clearfix">
										<li>
											...
											<div class="item"><a href="#">{{ $room->hotel->location }}</a></div>
										</li>
										<li>
											<label>Room Type</label>
											<div class="item">{{ $room->type }}</div>
										</li>
										{{-- <li>
